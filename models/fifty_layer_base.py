...
class FiftyLayerBase:
    def build_triple_conv(self, inp, num_features, stride=1):
        x = Conv2D(num_features, (1, 1), strides=(stride, stride), padding='same', use_bias=False,
    ...
    def build_parallel_layers(self, inp, num_features, stride=1):
        ...
        x2 = Conv2D(num_features * 4, (1, 1), strides=(stride, stride), padding='same', use_bias=False,
                    data_format='channels_last')(inp)
